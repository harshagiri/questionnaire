...
const questions = [
  ...
  },
  {
    ...
    label: "Age group",
    type: "select",
    config: { part: "Patient Profile", section: "Basic Patient Details", source: "PDF" },
  },
  {
    key: "q2_gender",
    label: "Gender",
  ...
  },
  {
    ...
    type: "multi-select",
    config: { part: "Patient Profile", section: "Medical History", source: "PDF" },
  },
  {
  ...
  },
  {
    ...
    type: "multi-select",
    config: { part: "Patient Profile", section: "Previous Medical Reports Available", source: "PDF" },
  },
  {
    key: "q10_diagnosis_explained",
    label: "Has diagnosis been explained before",
    type: "select",
    config: { part: "Patient Profile", section: "Understanding of Your Diagnosis", source: "PDF" },
  },
  {
    key: "q11_main_reason",
    label: "Main reason for consultation",
    type: "select",
    config: { part: "Your Current Problem", section: "Current Problem", source: "PDF" },
  },
  {
  ...
  },
  {
    ...
    type: "multi-select",
    config: { part: "Your Current Problem", section: "Pain Behaviour and Triggers", source: "PDF" },
  },
  {
  ...
  },
  {
    ...
    type: "select",
    config: { part: "Symptom and Function Assessment", section: "Symptom Severity", source: "PDF" },
  },
  {
  ...
  },
  {
    ...
    type: "select",
    config: { part: "Symptom and Function Assessment", section: "Neurological Symptoms", source: "PDF" },
  },
  {
  ...
  },
  {
    ...
    type: "select",
    config: { part: "Symptom and Function Assessment", section: "Functional Disability", source: "PDF" },
  },
  {
    key: "q28_work_impact",
  ...
  },
  {
    ...
    type: "select",
    config: { part: "Symptom and Function Assessment", section: "Previous Treatment Journey", source: "PDF" },
  },
  {
  ...
  },
  {
    ...
    type: "select",
    config: { part: "Symptom and Function Assessment", section: "Your Concerns and Goals", source: "PDF" },
  },
  {
...
function cleanClinicalLabel(label) {
  return label
...
function cleanQuestionConfig(config) {
  return {
    ...config,
    part: cleanClinicalLabel(config.part),
    section: cleanClinicalLabel(config.section),
  };
}
...
async function main() {
  ...
  await prisma.questionnaireQuestion.createMany({
    data: questions.map((question, index) => ({
      ...
      helpText: null,
      sortOrder: index + 1,
      config: cleanQuestionConfig(question.config),
    })),
  });

  const distinctSections = new Set(questions.map((question) => cleanClinicalLabel(String(question.config.section))));
