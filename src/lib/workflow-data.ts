...
export const registrationSections: WorkflowSection[] = [
  {
    id: "reg-about",
    title: "About you",
    subtitle: "The essentials we need to create and identify your patient profile.",
    questions: [
      { id: "fullName", label: "Full name", type: "text", required: true },
      { id: "age", label: "Age in years", type: "number", min: 1, max: 120, required: true },
      {
        id: "gender",
        label: "Gender",
        type: "radio",
  ...
  },
  {
    id: "reg-contact",
    title: "Reach you",
    subtitle: "Secure login, location, and the language you prefer for consultation.",
    questions: [
      { id: "phone", label: "Mobile number", type: "tel", required: true },
      { id: "pinCode", label: "Six-digit PIN code", type: "text", required: false },
      { id: "city", label: "City or locality", type: "text", required: true },
      {
  ...
  },
  {
    id: "reg-day",
    title: "Your day",
    subtitle: "A quick physical snapshot and what most of your day feels like.",
    questions: [
      { id: "heightCm", label: "Height (cm)", type: "number", min: 100, max: 250, required: true },
      { id: "weightKg", label: "Weight (kg)", type: "range", min: 30, max: 200, step: 1, required: true },
      { id: "bmi", label: "BMI (auto-calculated)", type: "info-link", linkedFrom: "heightCm" },
      {
        id: "dailyMovement",
        label: "How does most of your day feel physically?",
        type: "radio",
        required: true,
        options: [
          { label: "Mostly sitting", value: "sitting" },
          { label: "Mostly standing", value: "standing" },
          { label: "Walking often", value: "walking" },
          { label: "Lifting or manual work", value: "manual" },
          { label: "Housework or caregiving", value: "caregiving" },
          { label: "My day varies", value: "varied" },
        ],
      },
      {
        id: "smoking",
        ...
        options: [
          ...
          { label: "Used before", value: "former" },
  ...
  },
  {
    ...
    subtitle: "Only the question that needs your attention stays open.",
    questions: [
      {
        id: "healthConditionsStatus",
        label: "Do you have an ongoing health condition?",
        type: "radio",
        required: true,
        options: [
          { label: "No", value: "no" },
      ...
      {
        id: "medicalHistory",
        label: "Select all conditions that apply",
        type: "multi-select",
        required: true,
        showIf: (a) => a.healthConditionsStatus === "yes",
        options: [
          { label: "Diabetes", value: "diabetes" },
      ...
      {
        id: "medicineStatus",
        label: "Do you take any regular medicines?",
        type: "radio",
        required: true,
        options: [
          { label: "No regular medicines", value: "no" },
          { label: "Yes", value: "yes" },
          { label: "Not sure", value: "not-sure" },
        ],
      },
      {
        id: "currentMedicines",
        label: "List your regular medicines",
        type: "textarea",
        required: true,
        helpText: "You can update this before each visit",
        showIf: (a) => a.medicineStatus === "yes",
      },
      {
        id: "allergyStatus",
        label: "Do you have a known allergy to a medicine?",
        type: "radio",
        required: true,
        options: [
      ...
      {
        id: "drugAllergies",
        label: "Which medicines are you allergic to?",
        type: "textarea",
        required: true,
        showIf: (a) => a.allergyStatus === "yes",
      },
      {
        id: "spineSurgeryStatus",
        label: "Have you had spine surgery before?",
        type: "radio",
        required: true,
        options: [
          { label: "No", value: "no" },
      ...
      },
      {
        ...
        type: "textarea",
        required: true,
        showIf: (a) => a.spineSurgeryStatus === "yes",
      },
      {
        id: "otherSurgeryStatus",
        label: "Have you had any other surgery?",
        type: "radio",
        required: true,
        options: [
          { label: "No", value: "no" },
      ...
      {
        id: "otherSurgeries",
        label: "Select all previous surgeries that apply",
        type: "multi-select",
        required: true,
        showIf: (a) => a.otherSurgeryStatus === "yes",
        options: [
  ...
  },
  {
    id: "reg-consent",
    title: "Your choice",
    subtitle: "Required care and privacy choices stay separate from optional research.",
    questions: [
      {
