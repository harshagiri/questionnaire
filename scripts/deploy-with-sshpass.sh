...
# Usage: ./scripts/deploy-with-sshpass.sh user@ip 'password' [branch] [remote_dir]
# Example: ./scripts/deploy-with-sshpass.sh ubuntu@168.144.67.25 'P@ssw0rd' main /home/ubuntu/questionnaire
